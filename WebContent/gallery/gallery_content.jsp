														...
														<div class="tbarticle">
															<div class="arthead">
																<div class="artinfo">
																	...
																	<div class="artdate">
																		<span><%=gb.getReg_date() %></span>
																	</div>
																	<div class="artread">
																		<span><strong>조회수 : </strong><%=gb.getReadcount() %></span>
																	</div>
																</div>
															</div>
															<div class="artmain">
																...
																<div class="artcontent">
																	<p>
																	<img src="../upload_img/<%=gb.getImg_name() %>">
																	<br>
																	<%=gb.getContent() %>
																	</p>
																</div>
																<div class="artfile">
																	...
																	<p>
																	이미지파일 : <a href="gallery_down.jsp?file=<%=gb.getImg_name()%>"><%=gb.getImg_name() %></a>
																	</p>
																</div>
															</div>
															<div class="artbtn">
																<div class="btn">
																	<%if(id.equals(gb.getId()) || id.equals("administrator")) {%>
																	<a href="gallery_update.jsp?num=<%=num%>&pageNum=<%=pageNum%>">수정하기</a> |
																	<a href="gallery_delete.jsp?num=<%=num%>&pageNum=<%=pageNum%>">삭제하기</a> |
																	<%} %>
																	<a href="gallery_main.jsp?pageNum<%=pageNum%>">목록보기</a> |
													...
													<td>
														<div class="tbarticle">
															...
															<div class="cmt_write">
																...
																<form action="gallery_commentPro.jsp" method="post">
