														...
														<div class="tbarticle">
															<div class="arthead">
																<div class="artinfo">
																	...
																	<div class="artdate">
																		<span><%=fbb.getDate() %></span>
																	</div>
																	<div class="artread">
																		<span><strong>조회수 : </strong><%=fbb.getReadcount() %></span>
																	</div>
																</div>
															</div>
															<div class="artmain">
																<div class="artsubject">
																	<h2><%=fbb.getSubject() %></h2>
																</div>
																...
																<div class="artfile">
																	...
																	<p>
																	첨부파일 : <a href="fboard_down.jsp?file=<%=fbb.getFile()%>"><%=fbb.getFile() %></a>
																	</p>
																</div>
															</div>
															<div class="artbtn">
																<div class="btn">
																	<%if(id.equals(fbb.getId()) || id.equals("administrator")) {%>
																	<a href="fboard_update.jsp?num=<%=num%>&pageNum=<%=pageNum%>">수정하기</a> |
																	<a href="fboard_delete.jsp?num=<%=num%>&pageNum=<%=pageNum%>">삭제하기</a> |
																	<%} %>
																	<a href="fboard_reply.jsp?num=<%=num%>&pageNum=<%=pageNum%>&re_ref=<%=fbb.getRe_ref()%>&re_lev=<%=fbb.getRe_lev()%>&re_seq=<%=fbb.getRe_seq()%>">답글쓰기</a> |
																	<a href="fboard_main.jsp?pageNum<%=pageNum%>">목록보기</a> |
													...
													<td>
														<div class="tbarticle">
															...
															<div class="cmt_write">
																...
																<form action="../board/board_commentPro.jsp" method="post">
