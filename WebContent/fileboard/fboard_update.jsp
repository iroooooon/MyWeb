...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2>자료실 글 수정</h2>
      <form action="fboard_updatePro.jsp?pageNum=<%=pageNum %>" method="post" enctype="multipart/form-data">
      <input type="hidden" name="num" value="<%=num %>">
      	<div class="write_main">
      		<div class="write_group">
      			...
      			<div class="row_group">
 		     		<label>제목</label><br>
      				<input type="text" name="subject" value="<%=fbb.getSubject()%>">		
      			</div>
      			<div class="row_group">
 		     		<label>첨부파일</label><br>
      			...
      			<div class="row_group">
 		     		<label>내용</label><br>
 		     		<textarea name="content" cols="77" rows="20"><%=fbb.getContent() %></textarea>	
      			</div>
