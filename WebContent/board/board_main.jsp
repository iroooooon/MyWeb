  ...
  <div class="leftcolumn">
    <div class="card" id="card_bm">
      ...
      <div class="board_area">
      	<table class="board_tb">
			...
			<tr class="board_con">
      			...
      			<td class="tbtd"><%=bb.getId() %></td>
      			<td class="tbtd"><%=bb.getDate() %></td>
      			<td class="tbtd"><%=bb.getReadcount() %></td>
      		</tr>
      		<%
     			}
      		}
      ...
      <span>-</span>
      	...
      	<div id="wrbtn">
      		<input class="board_wr_btn" type="button" value="글 쓰기" onclick="location.href='board_write.jsp';">
      	</div>
      </div>
     </div>
    </div>
